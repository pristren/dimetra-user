...
export default function Language() {
  ...
  return (
    ...
    >
      <SelectTrigger className="w-min focus:ring-0  focus:ring-offset-0 border-none" isDownArrowHidden={true}>
        <SelectValue asChild placeholder="">
          <div className="flex items-center gap-2">
            <p className="text-4xl mb-0">{defaultLanguage.icon}</p>
            <p className="mb-0 mr-3 hidden lg:block">{defaultLanguage.name}</p>
          </div>
        </SelectValue>
      </SelectTrigger>

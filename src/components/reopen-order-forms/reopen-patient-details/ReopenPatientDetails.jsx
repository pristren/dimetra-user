...
const ReopenPatientDetails = ({
  ...
  const handleDateInput = (e, field, setReopenOrderData, form, path) => {
          ...
          <form>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        placeholder={
                          reopenOrderData.transportationData
                      ...
                      <div className="flex items-center">
                        <FormControl>
                          <Checkbox
                            ...
                            checked={
                              reopenOrderData.patientData.patient_above_90kg
                            }
                          />
                        </FormControl>
                        <Label
              ...
              <div className="flex items-start justify-start gap-5">
                      ...
                      <div className="flex items-center">
                        <FormControl>
                          <Checkbox
                            ...
                            checked={reopenOrderData.patientData.isolation}
                          />
                        </FormControl>
                        <Label
                          htmlFor="isolation"
                ...
                />
                {reopenOrderData.patientData.isolation && (
                  <FormField
                    control={form.control}
                    name="which"
                    render={({ field }) => (
...
export default ReopenPatientDetails;
